...
var ApiFlickr = {
	...
	*/ 
	_parametres_requete_par_defaut: {
		'format': 'json',
		'api_key': '8e5108509129d827bb4f7dece3d46b75',
		'lang': 'fr-fr',
		'per_page': 10,
  ...
  */
	...
	*/
	query: function(methode, parametres, callback) {
  ...
  */
	_requeter: function(parametres, callback) {
		var  parametresMerge = {};
		jQuery.extend(parametresMerge,this._parametres_requete_par_defaut, parametres),
		jQuery.ajax({
			url: this._url_service,
			type: 'get',
			data: parametresMerge,
			dataType: 'jsonp',
